...
// OCR requires Tesseract or similar backend
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    ...
                    >
                        ...
                        <div className="p-6 space-y-4">
                            <div
                                {...getRootProps()}
                                className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-all ${isDragActive ? 'border-cyan-400 bg-cyan-50' : 'border-gray-200 hover:border-cyan-300 hover:bg-cyan-50/50'}`}
                            >
                                <input {...getInputProps()} />
                            ...
                            <BackendRequiredBanner
                                ...
                                description="Extracting text from scanned PDFs requires Tesseract OCR or similar server-side processing."
                            />
                        </div>
