...
// Compression requires backend (Ghostscript or similar)
                    ...
                    >
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <BackendRequiredBanner
                                ...
                                description="Compressing PDFs requires server-side processing to reduce file size while maintaining quality."
                            />
                        </div>
